...
public class Movie implements Parcelable {
    ...
    public Movie(String title, String studio, Double budget, Date release, Integer duration, GenreEnum genre, ParentalGuidanceEnum pGuidance, Float rating, Boolean watched, String posterUrl) {
        this.title = title;
        this.studio = studio;
        this.budget = budget;
        this.release = release;
